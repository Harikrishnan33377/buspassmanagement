			...
			while(true) {
	        	...
	        	switch (choice) {
					...
					case 4:
						...
						System.out.println("3: View Expired Passes");
						System.out.println("4: View Pass in Date Range");
						System.out.println("5: Update Pass Request");
						System.out.println("6: Delete Pass Request");
						...
						if(passChoice == 1) {
							...
							passService.viewExpiredPasses();
						}else if(passChoice == 4) {
							passService.viewPassesInRange();
